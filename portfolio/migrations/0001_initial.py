    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills_overview_ml_title', models.CharField(blank=True, default='Deep Learning & ML Libraries', help_text="Title for the 'Deep Learning & ML Libraries' card on the index page.", max_length=100, null=True)),
                ('skills_overview_datasci_title', models.CharField(blank=True, default='Python & Data Science', help_text="Title for the 'Python & Data Science' card on the index page.", max_length=100, null=True)),
                ('skills_overview_general_title', models.CharField(blank=True, default='General IT & Other Skills', help_text="Title for the 'General IT & Other Skills' card on the index page.", max_length=100, null=True)),
                ('about_me_introduction', models.CharField(blank=True, default='I am a machine learning engineer.', help_text='Short introduction about me', max_length=100, null=True)),
                ('about_me_details', models.CharField(blank=True, default='I am passionate about leveraging my background in Python and a suite of Data Science tools.', help_text='Going into more detail about me.', max_length=100, null=True)),
